...
rm -r ../org3/peers/peer1/assets/mychannel.block
sleep 2s
...
export COMPOSE_PROJECT_NAME=cmd
COMPOSE_HTTP_TIMEOUT=300 docker-compose -f compose.yaml up -d
sleep 10s
...
cp ../org1/peers/peer1/assets/mychannel.block ../org3/peers/peer1/assets/mychannel.block
...
docker exec -e "CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org3/admin/msp" -e "CORE_PEER_ADDRESS=peer1-org3:7051" cli-org3 peer channel join -b /tmp/hyperledger/org3/peer1/assets/mychannel.block
sleep 2s
echo "                                                                "
echo "################################################################"
echo "############### joining peer1-org3 to my channel    ############"
echo "################################################################"
echo "                                                                "


docker exec -e "CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org3/admin/msp" -e "CORE_PEER_ADDRESS=peer2-org3:7051" cli-org3 peer channel join -b /tmp/hyperledger/org3/peer1/assets/mychannel.block
sleep 2s
echo "                                                                "
echo "################################################################"
echo "############### joining peer2-org3 to my channel    ############"
echo "################################################################"
echo "                                                                "
...
docker exec -e "CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org3/admin/msp" -e "CORE_PEER_ADDRESS=peer1-org3:7051" cli-org3 peer chaincode install -n mycc -v 1.0 -p github.com/hyperledger/fabric-samples/chaincode/sacc/
sleep 2s
echo "                                                                "
echo "################################################################"
...
docker exec -e "CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org3/admin/msp" -e "CORE_PEER_ADDRESS=peer2-org3:7051" cli-org3 peer chaincode install -n mycc -v 1.0 -p github.com/hyperledger/fabric-samples/chaincode/sacc/
sleep 2s
echo "################################################################"
...
echo "################################################################"
echo "############### instantiating chaincode on peer2-org3      #####"
echo "################################################################"
echo "                                                                "

docker exec -e "CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org3/admin/msp" -e "CORE_PEER_ADDRESS=peer2-org3:7051" cli-org3 peer chaincode instantiate -C mychannel -n mycc -v 1.0 -c '{"Args":["a","10"]}' -o orderer1-org0:7050 --tls --cafile /tmp/hyperledger/org3/peer1/tls-msp/tlscacerts/tls-0-0-0-0-7052.pem

sleep 10

docker exec -e "CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org3/admin/msp" -e "CORE_PEER_ADDRESS=peer2-org3:7051" cli-org3 peer chaincode query -C mychannel -n mycc -c '{"Args":["query","a"]}'
